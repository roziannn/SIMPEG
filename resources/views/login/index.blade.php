...
<div class="login-box">
    <div class="login-logo">
        <a href="#"><b>Pertamnia</b>Persero</a>
      </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    @csrf
      <div class="form-group has-feedback">
        <input type="text" name="nip" class="form-control @error('nip') is-invalid @enderror" placeholder="NIP" id="nip" autofocus required value="{{ old('nip') }}">
        @error('nip')
